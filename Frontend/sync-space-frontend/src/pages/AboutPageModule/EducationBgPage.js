  ...
  return (
    <div className="bg-indigo-600 w-full h-full fixed grid grid-cols-3 grid-rows-3">
      <div classNaame="w-full h-full grid grid-cols-2 row-span-2 col-span-2">
        <img src="/retroCamera.png" alt="retroCAm" className="rounded-lg w-full h-full ml-24 z-10 "/>
        <img src="/Mypic2.jpg" alt="mypic2" className=" relative rounded-lg w-2/4 h-2/4 mt-24 right-28 shadow-xl shadow-indigo-50 ring-2 rotate-6 "/>
      </div>
      <div className="grid items-center relative right-28">
